...
export default function AboutPage() {
  return (
    <main
      className="min-h-screen bg-[url('/uttrakhand-bg.jpeg')] bg-cover bg-center relative"
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-slate-900/80 via-slate-900/80 to-slate-950/90 backdrop-blur-[2px]" />
        ...
        <section className="py-16 px-6 bg-gradient-to-r from-orange-600/20 to-red-600/20 border-b border-orange-400/20">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300">
              Celebrating Uttarakhand's Rich Cultural Heritage
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 border border-orange-400/30 rounded-2xl p-8">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                The Silver Jubilee Celebration of Uttarakhand Foundation Day is
                a grand cultural event organized by BTKIT Dwarahat. This
                celebration aims to showcase the vibrant traditions, art, music,
                and cultural heritage of Uttarakhand, also known as "Devbhoomi"
                (Land of Gods).
              </p>
              <p className="text-gray-300 leading-relaxed">
                Through various cultural events and performances, we celebrate
                the spirit of Uttarakhand and provide a platform for talented
                individuals to express their creativity and showcase their
                skills.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 border border-orange-400/30 rounded-2xl p-8">
              ...
              <ul className="space-y-4 text-gray-300">
                {[
                  "Showcase your talents on a prestigious platform",
                  "Celebrate and preserve Uttarakhand's cultural heritage",
                  "Develop social and cultural skills",
                  "Connect with like-minded individuals and artists",
                  "Gain recognition and appreciation for your work",
                ].map((item, idx) => (
