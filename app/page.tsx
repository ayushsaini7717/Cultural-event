    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950">
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img
            src="/uttarakhand-background.jpg"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-3xl md:text-4xl text-orange-300 font-semibold mb-4">Uttarakhand Foundation Day</p>
          <p className="text-xl text-cyan-200 italic mb-8">"Enhancing Social and Cultural Skills"</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <Link key={event.name} href={`/events/${event.name.toLowerCase().replace(/\s+/g, "-")}`}>
                <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 border border-orange-400/30 rounded-2xl p-8 hover:border-cyan-400/60 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/20 cursor-pointer">
